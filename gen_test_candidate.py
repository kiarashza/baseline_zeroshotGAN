...
rel2candidates = json.load(open("./origin_data/community/rel2candidates_all.json"))
e1rel_e2 = json.load(open("./origin_data/community/e1rel_e2_all.json"))

relation2id = json.load(open("./origin_data/community/relation2ids"))
entity2id = json.load(open("./origin_data/community/entity2id"))
...
def gen_test_candidates(now_tasks, mode):
    ...
    json.dump(test_candidates, open("./origin_data/community/" + mode + "_candidates.json", "w"))
    print("Finish", mode, "candidates!!")
    return test_candidates

if __name__ == '__main__':
    dev_tasks = json.load(open("./origin_data/community/dev_tasks.json"))
    test_tasks = json.load(open("./origin_data/community/test_tasks.json"))
    train_tasks = json.load(open("./origin_data/community/train_tasks.json"))
