...
def read_options():
    ...
    parser.add_argument("--embed_dim", default=320, type=int, help='dimension of triple embedding')
    parser.add_argument('-w_dim', type=int, default=15, help='dimension of word embedding [50, 300]')
    parser.add_argument("--ep_dim", default=640, type=int, help='dimension of entity pair embedding')
    parser.add_argument("--noise_dim", default=15, type=int)
    ...
    parser.add_argument("--pretrain_times", default=50, type=int, help='total training steps for pretraining')
    parser.add_argument("--pretrain_loss_every", default=50, type=int)
    ...
    # training times
    parser.add_argument("--train_times", default=10, type=int)
    ...
    parser.add_argument("--pretrain_feature_extractor",default=True ,action='store_true')
